...
extra_headers = sys.argv[4]
output_archive_path = sys.argv[5]

assert sys.argv[6]=="stored" or sys.argv[6] == "compressed"
compression = zipfile.ZIP_DEFLATED if sys.argv[6] == "compressed" else zipfile.ZIP_STORED
...
with io.BytesIO() as new_zip_buffer:
    ...
    with zipfile.ZipFile(new_zip_buffer, 'a', compression=compression) as original_zip:
        ...
        # Copy in splashkit-arrays.h, stopgap until we update Splashkit TODO: Remove once updated
        copy_in_file(new_zip, extra_headers, "include/splashkit-arrays.h");
        ...
        // Patch in some newer SplashKit functions, TODO: Remove once updated
